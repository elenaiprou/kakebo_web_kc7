...
from kakebo.forms import MovimientosForm, FiltraMovimientosForm #importar classe de movimientos de formulario para poder cargarlo
...
def nuevo():
    formulario = MovimientosForm() #es una instancia de la clase MovimientosForm
